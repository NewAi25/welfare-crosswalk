...
This is the narrowed successor of `C:\Epoch Ai project\plf\plf-audit` (github.com/NewAi25/plf-audit), which is frozen. Column 1 (57 indicators), most of column 2 (20 products with Stygar validation levels), the hash verified corpus and the verification gate were built there and copied here. docs/PLF_Handover_2026-09-23.md says what was attempted and why it narrowed. docs/kevin_answers.md holds Kevin's steer of 25 September 2026: the three criteria are soft factors that make adoption easier, not filters, so the deliverable is a ranked table with every factor visible.
